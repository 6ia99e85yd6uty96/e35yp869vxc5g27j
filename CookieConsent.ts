class CookieConsent {
    ...
    public init() {
        let isWhitePage = promoRouter.promoType == promoRouter.promoTypeWhitePage && !/^promo-sandbox\./.test(location.hostname);
    ...
    public static onClick(container: HTMLElement, event: Event) {
