var DateFormatterTests = /** @class */ (function () {
    function DateFormatterTests() {
        this._srcDate = new Date('2017-12-25T09:22:33Z');
        this._dateFormatter = new DateFormatter(this._srcDate);
    }
    DateFormatterTests.prototype.run = function () {
    ...
    DateFormatterTests.prototype.testSingle = function (methodName, linguisticInfo, dateInputFormat, expectedResult) {
        var result;
